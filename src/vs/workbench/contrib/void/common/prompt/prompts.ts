...
export const builtinTools: {
	...
	git_status: {
		name: 'git_status',
		description: `Runs 'git status' to show the working tree status.`,
		params: {
			cwd: { description: cwdHelper },
		},
	},
	...
	git_diff: {
		name: 'git_diff',
		description: `Runs 'git diff' to show changes between commits, commit and working tree, etc.`,
		params: {
			cwd: { description: cwdHelper },
			args: { description: 'Optional. Arguments to pass to git diff (e.g. "--staged", "HEAD^", or a filename).' },
		},
	},

	git_commit: {
		name: 'git_commit',
		description: `Runs 'git commit -m <message>'.`,
		params: {
			cwd: { description: cwdHelper },
	...
	git_branch: {
		name: 'git_branch',
		description: `Manage branches. Defaults to listing branches if no other action is specified.`,
		params: {
			cwd: { description: cwdHelper },
			name: { description: 'Optional. The name of the branch to create or delete.' },
			delete: { description: 'Optional. Set to true to delete the branch specified by "name".' },
		},
	},
	...
	git_push: {
		...
		params: {
			cwd: { description: cwdHelper },
			remote: { description: 'Optional. The remote repository (e.g. "origin").' },
			branch: { description: 'Optional. The branch to push.' },
		},
	},
	...
	git_log: {
		...
		params: {
			cwd: { description: cwdHelper },
			count: { description: 'Optional. Number of commits to show (default 10).' },
		},
	},
	...
	git_rebase: {
		...
		params: {
			cwd: { description: cwdHelper },
			branch: { description: 'The upstream branch to rebase onto.' },
		},
	},
	...
	git_stash: {
		...
		params: {
			cwd: { description: cwdHelper },
			command: { description: 'Optional. "push", "pop", "list", or "apply". Defaults to "push".' },
		},
	},
	...
	git_tag: {
		...
		params: {
			cwd: { description: cwdHelper },
			command: { description: 'Optional. "list", "create", or "delete". Defaults to "list".' },
			name: { description: 'Optional. The name of the tag (required for create/delete).' },
		},
	},
	...
	git_checkout: {
		...
		params: {
			cwd: { description: cwdHelper },
			branch: { description: 'The branch to switch to.' },
		},
	},
	...
	move_file_or_folder: {
		...
		params: {
			source_uri: { description: `The FULL path to the source file or folder.` },
			target_uri: { description: `The FULL path to the target location.` },
		},
	},
	...
	project_index: {
		name: 'project_index',
		description: `Returns a list of all files in the workspace. Useful for getting a high-level overview of the project structure.`,
		params: {},
	},

	project_dependencies: {
		name: 'project_dependencies',
		description: `Returns the content of dependency manifest files (e.g. package.json, go.mod, Cargo.toml) to understand project dependencies.`,
		params: {},
	},

	lsp_symbols: {
		name: 'lsp_symbols',
		description: `Returns all symbols (functions, classes, etc.) in a given file.`,
		params: {
			...uriParam('file'),
		},
	},
	...
	lsp_definitions: {
		...
		description: `Returns the location of the definition of the symbol at the given position.`,
		params: {
			...uriParam('file'),
			line: { description: `The line number of the symbol.` },
			column: { description: `The column number of the symbol.` },
		},
	},

	lsp_references: {
		name: 'lsp_references',
		description: `Returns all references to the symbol at the given position.`,
		params: {
			...uriParam('file'),
			line: { description: `The line number of the symbol.` },
			column: { description: `The column number of the symbol.` },
	...
	lsp_hover: {
		name: 'lsp_hover',
		description: `Returns the hover information (documentation, types, etc.) for the symbol at the given position.`,
		params: {
			...uriParam('file'),
			line: { description: `The line number of the symbol.` },
			column: { description: `The column number of the symbol.` },
	...
	lsp_format: {
		name: 'lsp_format',
		description: `Formats the given file using the default formatter.`,
		params: {
			...uriParam('file'),
		},
	},
	...
	lsp_rename: {
		name: 'lsp_rename',
		description: `Renames the symbol at the given position to a new name.`,
		params: {
			...uriParam('file'),
			line: { description: `The line number of the symbol.` },
			column: { description: `The column number of the symbol.` },
			newName: { description: `The new name for the symbol.` },
		},
	},

	lsp_organize_imports: {
		name: 'lsp_organize_imports',
		description: `Organizes imports in the given file.`,
		params: {
			...uriParam('file'),
		},
	},
	...
	lsp_code_actions: {
		...
		description: `Returns available code actions (refactorings, fixes) for the symbol at the given position.`,
		params: {
			...uriParam('file'),
			line: { description: `The line number of the symbol.` },
			column: { description: `The column number of the symbol.` },
	...
	project_symbols: {
		...
		description: `Searches for symbols (functions, classes, etc.) across the entire project matching the given query.`,
		params: {
			query: { description: `The search query for symbols.` },
		},
	},

	editor_open: {
		name: 'editor_open',
		description: `Opens the given file in the editor to make it visible to the user.`,
		params: {
			...uriParam('file'),
		},
	},
	...
	editor_scroll: {
		name: 'editor_scroll',
		description: `Scrolls the editor to the specified line.`,
		params: {
			...uriParam('file'),
			line: { description: `The line number to scroll to.` },
		},
	},

	terminal_focus: {
		name: 'terminal_focus',
		description: `Focuses the specified terminal.`,
		params: {
			terminalId: { description: `The ID of the terminal to focus.` },
		},
	},

	terminal_clear: {
		name: 'terminal_clear',
		description: `Clears the specified terminal.`,
		params: {
			terminalId: { description: `The ID of the terminal to clear.` },
		},
	},

	editor_close: {
		name: 'editor_close',
		description: `Closes the editor for the given file.`,
		params: {
			...uriParam('file'),
		},
	},
	...
	editor_selection: {
		...
		description: `Sets the selection in the editor for the given file.`,
		params: {
			...uriParam('file'),
			startLine: { description: `The start line of the selection.` },
			startColumn: { description: `The start column of the selection.` },
			endLine: { description: `The end line of the selection.` },
			endColumn: { description: `The end column of the selection.` },
		},
	},
...
export const prismPrefixAndSuffix = ({ fullFileStr, startLine, endLine }: { fullFileStr: string, startLine: number, endLine: number }) => {
