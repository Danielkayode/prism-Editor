...
export interface IPrismDirectoryStrService {
...
export const IPrismDirectoryStrService = createDecorator<IPrismDirectoryStrService>('prismDirectoryStrService');
...
class PrismDirectoryStrService extends Disposable implements IPrismDirectoryStrService {
...
registerSingleton(IPrismDirectoryStrService, PrismDirectoryStrService, InstantiationType.Delayed);
