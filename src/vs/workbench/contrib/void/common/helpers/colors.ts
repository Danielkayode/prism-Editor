...
// gets converted to --vscode-prism-greenBG, see prism.css, asCssVariable
registerColor('prism.greenBG', configOfBG(acceptBG), '', true);
registerColor('prism.redBG', configOfBG(rejectBG), '', true);
registerColor('prism.sweepBG', configOfBG(sweepBG), '', true);
registerColor('prism.highlightBG', configOfBG(highlightBG), '', true);
registerColor('prism.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
