...
export type PrismStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
export const displayInfoOfProviderName = (providerName: ProviderName): DisplayInfoForProviderName => {
	...
	else if (providerName === 'unbound') {
		return { title: 'Unbound', }
	}
	else if (providerName === 'requesty') {
		return { title: 'Requesty', }
	}
	else if (providerName === 'baseten') {
		return { title: 'Baseten', }
	}
	else if (providerName === 'chutes') {
		return { title: 'Chutes AI', }
	}
	...
	else if (providerName === 'io_intelligence') {
		return { title: 'IO Intelligence', }
	}
	else if (providerName === 'minimax') {
		return { title: 'MiniMax', }
	}
	else if (providerName === 'moonshot') {
		return { title: 'Moonshot', }
	}
	else if (providerName === 'ovhcloud') {
		return { title: 'OVHcloud AI Endpoints', }
	}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'fireworks') return 'Get your [API Key here](https://fireworks.ai/account/api-keys).'
	if (providerName === 'together') return 'Get your [API Key here](https://api.together.xyz/settings/api-keys).'
	if (providerName === 'deepinfra') return 'Get your [API Key here](https://deepinfra.com/dash/api_keys).'
	...
	if (providerName === 'glama') return 'Get your [API Key here](https://glama.ai/settings/keys).'
	if (providerName === 'unbound') return 'Get your [API Key here](https://getunbound.ai).'
	if (providerName === 'requesty') return 'Get your [API Key here](https://requesty.ai).'
	if (providerName === 'baseten') return 'Get your [API Key here](https://www.baseten.co).'
	if (providerName === 'chutes') return 'Get your [API Key here](https://chutes.ai).'
	if (providerName === 'doubao') return 'Get your [API Key here](https://console.volcengine.com/ark).'
	if (providerName === 'huggingface') return 'Get your [API Key here](https://huggingface.co/settings/tokens).'
	if (providerName === 'inception') return 'Get your [API Key here](https://inceptionlabs.ai).'
	if (providerName === 'io_intelligence') return 'Get your [API Key here](https://io-intelligence.ai).'
	if (providerName === 'minimax') return 'Get your [API Key here](https://platform.minimax.io/user-center/basic-information/interface-key).'
	if (providerName === 'moonshot') return 'Get your [API Key here](https://platform.moonshot.ai/console/api-keys).'
	if (providerName === 'ovhcloud') return 'Get your [API Key here](https://endpoints.ai.cloud.ovh.net).'
	if (providerName === 'sambanova') return 'Get your [API Key here](https://cloud.sambanova.ai).'
	if (providerName === 'zai') return 'Get your [API Key here](https://bigmodel.cn/usercenter/apikeys).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: PrismStatefulModelInfo[] } => {
	return {
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	...
	unbound: {
		...defaultCustomSettings,
		...defaultProviderSettings.unbound,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.unbound),
		_didFillInProviderSettings: undefined,
	},
	requesty: {
		...defaultCustomSettings,
		...defaultProviderSettings.requesty,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.requesty),
		_didFillInProviderSettings: undefined,
	},
	baseten: {
		...defaultCustomSettings,
	...
	chutes: {
		...defaultCustomSettings,
		...defaultProviderSettings.chutes,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.chutes),
		_didFillInProviderSettings: undefined,
	},
	doubao: {
		...defaultCustomSettings,
		...defaultProviderSettings.doubao,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.doubao),
		_didFillInProviderSettings: undefined,
	},
	huggingface: {
		...defaultCustomSettings,
	...
	io_intelligence: {
		...defaultCustomSettings,
		...defaultProviderSettings.io_intelligence,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.io_intelligence),
		_didFillInProviderSettings: undefined,
	},
	minimax: {
		...defaultCustomSettings,
	...
	ovhcloud: {
		...defaultCustomSettings,
		...defaultProviderSettings.ovhcloud,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.ovhcloud),
		_didFillInProviderSettings: undefined,
	},
	sambanova: {
		...defaultCustomSettings,
