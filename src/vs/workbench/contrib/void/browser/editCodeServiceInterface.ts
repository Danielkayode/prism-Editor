...
import { Diff, DiffArea, PrismFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getPrismFileSnapshot(uri: URI): PrismFileSnapshot;
	restorePrismFileSnapshot(uri: URI, snapshot: PrismFileSnapshot): void;
}
